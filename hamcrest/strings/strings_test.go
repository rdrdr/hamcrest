...
func Test_ToString_builtinTypes(t *testing.T) {
	we := asserter.Using(t)
	we.CheckThat(123, Not(EqualTo("123")))
	we.CheckThat(123, ToString(EqualTo("123")))
}
...
func Test_ToString_onTypesThatImplementStringer(t *testing.T) {
	...
	we := asserter.Using(t)
	we.CheckThat(stringer, Not(EqualTo("123")))
	we.CheckThat(stringer, ToString(EqualTo("123")))
}
...
func Test_ToLower(t *testing.T) {
	...
	we.CheckThat("123", ToLower(EqualTo("123")))
	we.CheckThat(123, Not(ToLower(EqualTo("123"))))
}
...
func Test_ToUpper(t *testing.T) {
	...
	we.CheckThat("123", ToUpper(EqualTo("123")))
	we.CheckThat(123, Not(ToUpper(EqualTo("123"))))
}
